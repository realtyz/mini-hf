...
export const STRINGS = {
  ...
  cacheScanFilter: "筛选",
  cacheScanFilterActive: (n: number) => `筛选 ${n}`,
  cacheScanFilterClear: "清除",
  cacheScanFilterApply: "应用",
  cacheScanFilterClearAll: "清除全部",
  cacheScanFilterCategory: "分类",
  cacheScanFilterSource: "来源",
  cacheScanFilterField: "作用字段",
  cacheScanFilterTime: "时间范围",
  cacheScanFilterIncludeNever: "包含从未下载/更新",
  cacheScanFilterAll: "全部",
  cacheScanFilterAllSources: "全部来源",
  cacheScanFilterTracked: "已追踪",
  cacheScanFilterUntracked: "未追踪",
  cacheScanFilterLastDownloaded: "最后下载",
  cacheScanFilterCacheUpdated: "缓存更新时间",
  cacheScanFilterDateStart: "起始",
  cacheScanFilterDateEnd: "截止",
  cacheScanFilterDateRange: (from: string, to: string) => `${from} → ${to}`,
  cacheScanFilterDateFrom: (from: string) => `${from} 起`,
  cacheScanFilterDateTo: (to: string) => `至 ${to}`,
