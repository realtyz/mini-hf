...
import { Loader2, Check, CheckCircle2, ArrowLeft, ArrowRight } from 'lucide-react'
          ...
          {step === 'form' ? (
            ...
            <>
              ...
              <Button
                ...
                disabled={createTask.isPending || step === 'creating' || previewTask.data?.all_required_cached || selectedFiles.size === 0}
                className="gap-1"
              >
