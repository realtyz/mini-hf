/**
 * Mini-HF Logo 的 SVG mark（纯图形，不含外层布局/文字）。
 * 唯一来源，shared/Logo 与 ConsoleLayout 内联 Logo 共用，避免 path 双份维护。
 */
export function MiniHfLogoMark({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="none"
  ...
  return (
    <div className="flex items-center gap-2.5 transition-transform duration-300 ease-out">
      <div className="relative">
        <MiniHfLogoMark className="h-8 w-8 text-foreground transition-transform duration-300 ease-out group-hover:scale-105 group-hover:rotate-3" />
