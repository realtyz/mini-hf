        ...
        <div className="mb-16 grid grid-cols-2 sm:grid-cols-4 border-y border-border/60 divide-x divide-border/60">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              ...
              className={
                i >= 2
                  ? "flex flex-col gap-3 px-5 py-5 border-t sm:border-t-0 border-border/60"
          ...
          <div className="border-y border-border/60">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                ...
                className={
                  i < 2
                    ? "flex items-center gap-5 px-2 py-4 border-b border-border/60"
                    : "flex items-center gap-5 px-2 py-4"
                }
              >
