...
export function RepositoryDetail({
  ...
  const namePart =
    slashIdx > 0 ? repo.repo_id.slice(slashIdx + 1) : repo.repo_id;
            ...
            <h1 className="font-semibold tracking-tight text-[28px] sm:text-[34px] leading-[1.15] break-all">
              {orgPart && (
                <>
                  ...
                  <span className="mx-1.5 text-muted-foreground/30 font-light">
                    /
                  </span>
                </>
              )}
              ...
              <span className="inline-flex items-center gap-1.5">
                <span
                  className={cn(
                    ...
                    getRepoStatusDotClass(repo.status as RepoStatus),
                  )}
                />
