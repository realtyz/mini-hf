...
class MsRepoSnapshot(Base):
    ...
    __tablename__ = "ms_repo_snapshots"
    __table_args__ = (
        # Core query: get active snapshot for a revision (used by MS API and worker)
        Index(
